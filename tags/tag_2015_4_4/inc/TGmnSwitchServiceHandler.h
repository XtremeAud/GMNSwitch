...
//	string EthName;
//	int LocalPortNum_RX;
//	string LocalIPAdd_RX = "127.0.0.1";
//	int RemotePortNum_TX;
//	string RemoteIPAdd_TX;
//
//	EthSimulator(string ethName, int RX_Port, string RX_Add, int TX_Port, string TX_Add)
//	{
//		EthName = ethName;
//		LocalPortNum_RX = RX_Port;
//		LocalIPAdd_RX = RX_Add;
//		RemotePortNum_TX = RX_Port;
//		RemoteIPAdd_TX = RX_Add;
//	}
//
//	EthSimulator(){}
//	~EthSimulator(){}
//
//	static int AddEth(string ethName, string localIP, int localPort, string remoteIP, int remotePort)
//	{
//		//Firstly check wether the Eth name is existed
//		for (int n = 0; n < EthList.size(); n++)
//		{
//			if (EthList[n].EthName == ethName)
//			{
//				return -1;
//			}
//		}
//
//		EthSimulator ethS;
//		ethS.EthName = ethName;
//		ethS.LocalIPAdd_RX = localPort;
//		ethS.LocalIPAdd_RX = localIP;
//		ethS.RemoteIPAdd_TX = remoteIP;
//		ethS.RemotePortNum_TX = remotePort;
//		EthList.push_back(ethS);
//	}
//};
